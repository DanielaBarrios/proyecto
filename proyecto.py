...
class App:
    ...
    def abrir(self): #buscar archivos 
    ...
    def screen_shot(self): #detectar codigos en la pantalla
    ...
    def visor(self): #inicializa la camara
    ...
    def active_cam(self): #opcion para leer codigos con la camara
    ...
    def capta(self,frm): #leer el codigo en pantalla por camara
    ...
    def get_frame(self): #cerrar camara
